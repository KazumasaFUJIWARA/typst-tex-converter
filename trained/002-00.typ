...
where $$t > 0, x \in \mathbb{R}^n.$$

Our goal is to establish the global existence of solutions under the initial conditions

$$\left(u_0, u_1\right) = \left(\varepsilon_0 \varphi, \varepsilon_1 \varphi\right),$$

where $$0 < \varepsilon_0 < |\varepsilon_1| = - \varepsilon_1,$$

$n = 1,$ and $\varphi$ is a regular non-negative function.
```