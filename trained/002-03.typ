...
$$u_0 = \varepsilon_0 \varphi,$$

$$u_1 = \varepsilon_1 \varphi.$$

Here, we assume that $n = 1$, $\varepsilon_0$ and $\varepsilon_1$ are small real numbers with $0 < \varepsilon_0 < |\varepsilon_1|$ and $\varphi$ is a regular non-negative function. Our goal is to show the global existence of solutions under these initial conditions.